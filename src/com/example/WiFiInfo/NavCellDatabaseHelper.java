 ...
 */
public class NavCellDatabaseHelper extends SQLiteOpenHelper {
    ...
    public  static final String DATABASE_NAV_CREATE =
            "create table" + DATABASE_TABLE + "(" +
                    ...
                    "fp_id integer not null,"+ "direction Text," +
                    "x_cord  integer not null, " + "y_cord integer not null," + "FOREIGN KEY(fp_id) REFERENCES fingerprint_table(fp_id));"   ;



    public NavCellDatabaseHelper(Context context) {
